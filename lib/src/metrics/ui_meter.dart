...
class _ScreenBoundCounter<T extends num> implements Counter<T>, BaseInstrument {
...
class _ScreenBoundHistogram<T extends num> implements Histogram<T>, BaseInstrument {
