...
class OTelMetricsBridge {
  ...
  void _setupApdexGauge() {
    _apdexScoreGauge = _getPerformanceMeter().createObservableGauge<double>(
      ...
      unit: '{score}',
      callback: (ObservableResult result) {
  ...
  Histogram<double> _getFrameTimeHistogram() {
    return _frameTimeHistogram ??= _getPerformanceMeter().createHistogram<double>(
  ...
  Histogram<double> _getPageLoadTimeHistogram() {
    return _pageLoadTimeHistogram ??= _getPerformanceMeter().createHistogram<double>(
  ...
  Histogram<double> _getInteractionTimeHistogram() {
    return _interactionTimeHistogram ??= _getUserInteractionMeter().createHistogram<double>(
  ...
  Histogram<double> _getLayoutShiftHistogram() {
    return _layoutShiftHistogram ??= _getPerformanceMeter().createHistogram<double>(
  ...
  void _handlePerformanceMetric(PerformanceMetric metric) {
    ...
    if (OTelLog.isLogMetrics()) {
      OTelLog.logMetric('OTelMetricsBridge: Processing performance metric: ${metric.name}');
    }
    ...
    _getFrameTimeHistogram().record(metric.duration.inMilliseconds.toDouble(), attributes);
  }
